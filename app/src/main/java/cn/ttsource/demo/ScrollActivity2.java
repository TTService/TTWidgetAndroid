...
import cn.ttsource.widget.HorizontalScrollViewEx2;
...
public class ScrollActivity2 extends AppCompatActivity {
    ...
    private void initView() {
        ...
        HorizontalScrollViewEx2 mListContainer = (HorizontalScrollViewEx2) this.findViewById(R.id.container);
    ...
    private void createList(ViewGroup layout) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(ScrollActivity2.this, "click item", Toast.LENGTH_SHORT).show();
            }
        });
    }
